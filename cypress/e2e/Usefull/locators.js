export class automationpractice_locators {
    static search_button = '#search_query_top';
    static submit_button = '[name="submit_search"]';
...
export class demo_qa {
    // cookies
    static cookies_consent = '.fc-button-label';

    // radiobuttons
    static radiobtns = '.card-footer-item[href="/radio"]';
    static radio_yes = '#yes';
    static radio_mb = '#maybe';
    static radio_nobug = '#nobug';
    static radio_no = '#no';

    // checkboxes
    static cbox = 'input[type="checkbox"]';
